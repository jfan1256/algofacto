...
class FactorSBETFTest(Factor):
    ...
    def __init__(self,
        ...
        self.factor_col = self.etf_data.columns
    ...
    def function(self, splice_data):
        ...
        for window in windows:
            betas = rolling_ols_sb_test(price=splice_data, factor_data=self.etf_data, factor_col=self.factor_col, window=window, name='ETF_TEST', ret=ret)
