...
class FactorLoadVolume(Factor):
    ...
    def __init__(self,
        ...
        self.factor_data = self.factor_data[['VOL_01']]
        ...
        self.factor_data = self.factor_data['VOL_01'].unstack(self.join)
    ...
    def function(self, splice_data):
        ...
        splice_data = pd.DataFrame(loading, columns=[f'load_volume_{i + 1}' for i in range(self.component)], index=[[date] * len(cols), cols])
