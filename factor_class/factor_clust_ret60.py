...
class FactorClustRet60(Factor):
    ...
    def __init__(self,
        ...
        window_size = 10
        self.factor_data = create_smooth_return(self.factor_data, windows=[60], window_size=window_size)
        self.factor_data = self.factor_data[[f'RET_60']]
        self.factor_data = self.factor_data['RET_60'].unstack(self.join)
    ...
    def function(self, splice_data):
        ...
        splice_data = pd.DataFrame(cluster, columns=[f'ret60_cluster'], index=[[date] * len(cols), cols])
