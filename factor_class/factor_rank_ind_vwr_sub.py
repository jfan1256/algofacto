...
class FactorRankIndVWRSub(Factor):
    @timebudget
    ...
    def __init__(self,
        ...
        ind = pd.read_parquet(get_load_data_parquet_dir() / 'data_ind_sub.parquet.brotli')
        ...
        for t in T:
            ...
            ind_data[f'rank_vwr_sub_{t:02}'] = ind_data.groupby(['Subindustry', 'date'])[f'vwr_{t:02}'].rank(method='dense')
            collect.append(ind_data[[f'rank_vwr_sub_{t:02}']])
