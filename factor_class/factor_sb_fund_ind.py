...
class FactorSBFundInd(Factor):
    ...
    def __init__(self,
        ...
        self.factor_col = self.fund_ind.columns[:-1]
    ...
    def function(self, splice_data):
        ...
        for window in windows:
            betas = rolling_ols_beta(price=splice_data, factor_data=self.fund_ind, factor_col=self.factor_col, window=window, name='MACRO', ret=ret)
