...
class FactorSBMacroTest(Factor):
    ...
    def function(self, splice_data):
        ...
        factors = self.macro_data.columns[:-1]
        t = 1
        ret = f'RET_{t:02}'
        ...
        for window in windows:
            betas = rolling_ols_sb(price=splice_data, factor_data=self.macro_data, factor_col=factors, window=window, name='MACRO_TEST', ret=ret)
