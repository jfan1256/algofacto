...
class FactorSBBondTest(Factor):
    ...
    def function(self, splice_data):
        ...
        for window in windows:
            betas = rolling_ols_sb(price=splice_data, factor_data=self.bond_data, factor_col=factors, window=window, name='BOND_TEST', ret=ret)
