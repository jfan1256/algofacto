...
class FactorRankIndMomSub(Factor):
    ...
    def __init__(self,
        ...
        ind_data = pd.read_parquet(get_parquet_dir(self.live) / 'data_ind_sub.parquet.brotli')
        ...
        for t in T:
            ...
            ret[f'indMomSub_{t:02}_rank'] =  ret.groupby(['date'])[f'IndMomSub_{t:02}'].rank(method='dense')
            collect.append(ret[f'indMomSub_{t:02}_rank'])
