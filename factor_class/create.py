...
from factor_class.factor_open_div import FactorOpenDiv
...
# # FactorOpenDiv(file_name='factor_open_div', skip=True, stock=permno, start=start, end=end).create_factor()
