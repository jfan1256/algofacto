...
class FactorSBOverall(Factor):
    ...
    def function(self, splice_data):
        ...
        factors = self.overall_data.columns[:-1]
        T = [1]
        ...
        for t in T:
            ...
            for window in windows:
                betas = rolling_ols_sb(price=splice_data, factor_data=self.overall_data, factor_col=factors, window=window, name=f'{t:02}_OVERALL', ret=ret)
