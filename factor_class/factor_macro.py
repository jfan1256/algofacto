...
class FactorMacro(Factor):
    ...
    def __init__(self,
        ...
        # Read in IF
        IF = pd.read_csv(get_large_dir(self.live) / 'macro' / 'fiveYearIR.csv')
        ...
        # Read in rIR
        rIR = pd.read_csv(get_large_dir(self.live) / 'macro' / 'realInterestRate.csv')
        ...
        # Read in UR
        UR = pd.read_csv(get_large_dir(self.live) / 'macro' / 'unemploymentRate.csv')
        UR.columns = ['date', 'UR']
        ...
        # Read in PPI
        PPI = pd.read_csv(get_large_dir(self.live) / 'macro' / 'PPI.csv')
        ...
        indProdIndex = pd.read_csv(get_large_dir(self.live) / 'macro' / 'indProdIndex.csv')
