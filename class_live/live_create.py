...
class LiveCreate:
    ...
    def exec_factor(self):
        ...
        FactorTalib(live=live, file_name='factor_talib', skip=True, stock=stock, start=self.start_factor, end=self.current_date, group='permno').create_factor()
        ...
        FactorAgeMom(live=live, file_name='factor_age_mom', skip=True, stock=stock, start=self.start_factor, end=self.current_date, group='permno').create_factor()
