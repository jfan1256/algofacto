...
vol = PrepFactor(factor_name='factor_volatility', interval='D', kind='price', tickers=tickers, div=False, start=start, end=end, save=save).prep()
alphaModel.add_factor(vol)
del vol
...
alphaModel.add_factor(load_ret)
del load_ret
...
alphaModel.add_factor(clust_ret, categorical=True)
del clust_ret
