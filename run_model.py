...
alpha = AlphaModel(model_name='lightgbm_trial_45', tuning='default', plot_loss=False, plot_hist=False, pred='price', stock='permno', lookahead=1, incr=True, opt='wfo',
...
alpha.add_factor(rank_load_ret, categorical=True)
del rank_load_ret
...
# open_asset = PrepFactor(factor_name='factor_open_asset', group='permno', interval='M', kind='open', stock=stock, div=True, start=start, end=end, save=save).prep()
...
# alpha.add_factor(rank_load_volume, categorical=True)
...
fund_raw = PrepFactor(factor_name='factor_fund_raw', group='permno', interval='D', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
...
alpha.add_factor(rank_volatility, categorical=True)
del rank_volatility
...
net_debt_finance = PrepFactor(factor_name='factor_net_debt_finance', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(net_debt_finance)
del net_debt_finance

chtax = PrepFactor(factor_name='factor_chtax', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(chtax)
del chtax

asset_growth = PrepFactor(factor_name='factor_asset_growth', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
...
noa = PrepFactor(factor_name='factor_noa', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(noa)
del noa

invest_ppe = PrepFactor(factor_name='factor_invest_ppe_inv', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(invest_ppe)
del invest_ppe

inv_growth = PrepFactor(factor_name='factor_inv_growth', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
...
earning_streak = PrepFactor(factor_name='factor_earning_streak', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
...
comp_debt = PrepFactor(factor_name='factor_comp_debt', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
...
cheq = PrepFactor(factor_name='factor_cheq', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(cheq)
del cheq

xfin = PrepFactor(factor_name='factor_xfin', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(xfin)
del xfin

emmult = PrepFactor(factor_name='factor_emmult', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(emmult)
del emmult

accrual = PrepFactor(factor_name='factor_accrual', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(accrual)
del accrual

"""abnormal_accrual = PrepFactor(factor_name='factor_abnormal_accrual', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
alpha.add_factor(abnormal_accrual)
del abnormal_accrual"""

frontier = PrepFactor(factor_name='factor_frontier', group='permno', interval='M', kind='fundamental', stock=stock, div=True, start=start, end=end, save=save).prep()
...
alpha.add_factor(rank_ind_mom_sub, categorical=True)
...
alpha.add_factor(rank_sb_pca, categorical=True)
del rank_sb_pca
...
alpha.add_factor(rank_sb_inverse, categorical=True)
del rank_sb_inverse
