from class_model.model_bayes import ModelBayes
...
bayes_params = {
    'n_iter':      {'optuna': ('suggest_float', 100, 1000),      'gridsearch': [100, 300, 500],         'default': 300},
    'tol':         {'optuna': ('suggest_float', 1e-6, 1e-3),     'gridsearch': [1e-6, 1e-5, 1e-4],      'default': 1e-3},
    'alpha_1':     {'optuna': ('suggest_float', 1e-6, 1e-3),     'gridsearch': [1e-6, 1e-5, 1e-4],      'default': 1e-6},
    'alpha_2':     {'optuna': ('suggest_float', 1e-6, 1e-3),     'gridsearch': [1e-6, 1e-5, 1e-4],      'default': 1e-6},
    'lambda_1':    {'optuna': ('suggest_float', 1e-6, 1e-3),     'gridsearch': [1e-6, 1e-5, 1e-4],      'default': 1e-6},
    'lambda_2':    {'optuna': ('suggest_float', 1e-6, 1e-3),     'gridsearch': [1e-6, 1e-5, 1e-4],      'default': 1e-6},
}
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------MODEL---------------------------------------------------------------------------------------------
alpha = ModelBayes(live=live, model_name=model_name, tuning=tune, plot_hist=False, pred='price', model='bayesian_ridge', stock='permno',
                   lookahead=1, trend=1, opt='ewo', outlier=False, train_len=504, valid_len=21, test_len=21, **bayes_params)
