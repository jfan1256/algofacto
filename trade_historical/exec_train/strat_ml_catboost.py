...
live = False
save = False
start_model = '2015-01-01'
current_date = '2023-01-01'
normalize = 'rank_normalize'
model_name = 'catboost_trial_1'
tune = 'default'
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------MODEL---------------------------------------------------------------------------------------------
alpha = ModelCatboost(live=live, model_name=model_name, tuning='default', plot_loss=False, plot_hist=False, pred='price', stock='permno', lookahead=1, opt='ewo',
                      outlier=False, early=True, train_len=504, valid_len=63, test_len=21, **catboost_params)
