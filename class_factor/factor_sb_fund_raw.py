...
class FactorSBFundRaw(Factor):
    ...
    def __init__(self,
        ...
        self.fama_data = pd.read_parquet(get_parquet(self.live) / 'data_fama.parquet.brotli')
        self.fund_data = pd.read_parquet(get_parquet(self.live) / 'data_fund_raw_q.parquet.brotli')
