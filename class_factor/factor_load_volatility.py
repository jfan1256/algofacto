...
class FactorLoadVolatility(Factor):
    ...
    def __init__(self,
        ...
        self.factor_data[f'Volatility_01'] = self.factor_data.groupby(self.group)[f'RET_01'].rolling(window=21).std().reset_index(level=0, drop=True)
    ...
    def function(self, splice_data):
        ...
        splice_data = pd.DataFrame(loading, columns=[f'load_volatility_{i + 1}' for i in range(5)], index=[[date] * len(cols), cols])
