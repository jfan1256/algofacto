...
from mrev_class.mrev_sd_epsil import MrevSDEpsil
...
class StratMrevETF:
    ...
    def backtest_mrev_etf(self):
        ...
        hedge_ret.to_parquet(get_strat_mrev_etf() / 'data' / 'data_hedge.parquet.brotli', compression='brotli')
    ...
    def exec_mrev_etf(self):
        ...
        historical_hedge = pd.read_parquet(get_strat_mrev_etf() / 'data_hedge.parquet.brotli', columns=['Close'])
        ...
        filename = get_live_stock() / 'trade_stock_mrev_etf.parquet.brotli'
